========================================================================
    KONSOLENANWENDUNG: 3DRekonstruktion-Projektübersicht
========================================================================

Diese 3DRekonstruktion-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre 3DRekonstruktion-Anwendung besteht.


3DRekonstruktion.vcxproj
...
3DRekonstruktion.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "3DRekonstruktion.pch und eine 
